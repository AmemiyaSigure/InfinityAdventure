...
public class ModItems {
    ...
    public static final RegistryObject<Item> ADAMANTINE_SWORD = ITEMS.register("adamantine_sword", () -> new ItemSwordBase(ModTiers.ADAMANTINE, 4, -3.9f, EnumSet.of(ItemFeature.ANTI_CORRUPTION), 1));
}
